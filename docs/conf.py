...
project = 'Sphinx Test'
copyright = '2018, davidlj95 & ccebrecos'
...
PROTECTED_ATTRIBUTE_DOC = ATTRIBUTE_DOC + " _"
PROTECTED_ATTRIBUTE_DOC_LINES = 3
...
def autodoc_process_docstring(app, what, name, obj, options, lines):
    ...
    if what == "class":
        ...
        while i < len(lines):
            # Detect if we have a protected attribute
            if lines[i].startswith(PROTECTED_ATTRIBUTE_DOC):
                protected_attr = True
            elif lines[i].startswith(ATTRIBUTE_DOC):
                protected_attr = False

            # Delete protected attribute line
            if protected_attr:
                lines.pop(i)
                i -= 1
